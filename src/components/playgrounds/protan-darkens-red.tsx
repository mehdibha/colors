    ...
    <Demo
      caption={
        <>
          ...
          through three eyes. Deuteranopia mutes the hue but barely touches its
          lightness (L* {lstar(RED)} &rarr; {lstar(DEUTAN.hex)}). Protanopia
          drops it into the shadows (L* {lstar(RED)} &rarr; {lstar(PROTAN.hex)})
          — protanopes are missing the long-wavelength cones, so red light
          carries far less luminance for them. This is the nuance behind
          &ldquo;lightness survives CVD&rdquo;: mostly true for deutan, but a
          red you tuned to a safe contrast can lose it for a protanope when it
          darkens against a dark surface.
        </>
      }
    >
