...
1. A teammate moves a card from step 2 to step 5 "because it looked better," and the step-11 body text on it now fails 4.5:1. They argue the text is fine — "it passed contrast." What exactly did the text's guarantee promise, and what are the two legitimate fixes?
2. Steps 3–4–5 and steps 6–7–8 encode the same kind of relationship. What is it, and why does regenerating step 3 alone — even to a perfectly nice color — break something no contrast meter will catch?
3. Your engine's design review proposes 8 steps instead of 12, "it's leaner." What question do you have to answer before you can agree, and what are two concrete things that stop existing when you merge slots?
