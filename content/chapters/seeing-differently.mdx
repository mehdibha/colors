...
3. A user has Windows High Contrast on. Your card uses a background gradient, a drop shadow, and a colored left border to signal "premium." What does the browser do to each of those three — and for the one still drawing anything, what exactly survives: its geometry, its color, or both?
