...
1. Walk the orange button through WCAG 2 by hand: Y is 0.3075 for the orange, 0 for black, 1 for white. Where does black's 7.15 actually come from — and why does APCA, which soft-clamps the dark end instead of dividing by a propped-up denominator, rank the two buttons the other way?
